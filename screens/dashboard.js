...
export default function Dashboard({ navigation }) {
  ...
  function getRaw() {
    axios
      .get(
        "https://raw.githubusercontent.com/BirdRa1n/Arduino_WebControl_Ethernet/main/WebControl/WebControl.ino"
      )
  ...
  const ActionsheetLights = () => {
    ...
    const storeSwitchs = async (value) => {
      try {
        ...
        await AsyncStorage.setItem("@Switchs", jsonValue);
      } catch (e) {}
    };
